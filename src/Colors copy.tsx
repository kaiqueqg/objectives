...
export const darkBlue: ObjectivePallete = {
  ...
  doneicontintexercise: colorPalette.green,
  ...
  trashicontintexercise: colorPalette.red,
  ...
  exercisebk: '#035a9c',
  exercisetext: colorPalette.beige,
  exercisetextfade: colorPalette.grey,
}
...
export const darkRed: ObjectivePallete = {
  ...
  doneicontintexercise: colorPalette.greendarker,
  ...
  trashicontintexercise: colorPalette.reddarker,
  ...
  exercisebk: '#942020',
  exercisetext: colorPalette.beige,
  exercisetextfade: colorPalette.black,
}
...
export const darkGreen: ObjectivePallete = {
  ...
  exercisebk: '#a8e3a8',
  exercisetext: colorPalette.black,
  exercisetextfade: colorPalette.greylighty,
}
...
export const noTheme: ObjectivePallete = {
  ...
  doneicontintexercise: colorPalette.greenlight,
  ...
  trashicontintexercise: colorPalette.redlight,
  ...
  exercisebk: colorPalette.bluedarkerdarker,
  exercisetext: colorPalette.beige,
  exercisetextfade: colorPalette.grey,
}
